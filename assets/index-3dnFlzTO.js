...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>U.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>U.jsxs("div",{className:"CommentInfo",children:[U.jsxs("div",{className:"CommentInfo__title",children:[U.jsx("strong",{className:"CommentInfo__name",children:e.name})," by"," ",U.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),U.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>U.jsx("div",{className:"CommentList",children:e.map(t=>U.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>{const{title:t,body:i,user:n,comments:a}=e;return U.jsxs("article",{className:"PostInfo",children:[U.jsxs("header",{className:"PostInfo__header",children:[U.jsx("h3",{className:"PostInfo__title",children:t}),U.jsxs("p",{children:["Posted by ",U.jsx(Pc,{user:n})]})]}),U.jsx("p",{className:"PostInfo__body",children:i}),U.jsx("hr",{}),a.length>0?U.jsx(Tc,{comments:a}):U.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})},Rc=Cc.map(e=>({...e,user:zc.find(t=>t.id===e.userId),comments:Nc.filter(t=>t.postId===e.id)})),Dc=()=>U.jsxs("section",{className:"App",children:[U.jsx("h1",{className:"App__title",children:"Static list of posts"}),U.jsx("div",{className:"PostList",children:Rc.map(e=>U.jsx(Mc,{post:e},e.id))})]});em(document.getElementById("root")).render(U.jsx(Dc,{}));
